...
const jsonLd = {
  ...
  mainEntityOfPage: 'https://zenexio.pro/resources/brand-launch-checklist-dubai'
};
    ...
    <main>
      ...
      <section className="section post-section">
        <div className="container post-container">
          ...
          <Reveal href="/resources/design-pricing-guide-dubai-india" className="post-back" delay={0.14}>Also free: our Design &amp; Website Pricing Guide for Dubai &amp; India &rarr;</Reveal>
