...
export const seo = {
  home: {
    title: 'Creative Agency in Dubai, UAE & India | Zenexio',
    description: 'Zenexio is a creative agency in Dubai, UAE and India crafting brand identity, web development, and digital marketing that helps ambitious brands stand out and grow. 1000+ projects delivered. Design beyond imagination.',
  ...
  about: {
    ...
    description: 'Founded in 2017, Zenexio is a creative partner for brands across Dubai, UAE and India — blending strategy, design, and technology. 1000+ projects delivered with a 98% client retention rate.',
  ...
  services: {
    title: 'Design, Web Dev & Marketing Services | Zenexio',
